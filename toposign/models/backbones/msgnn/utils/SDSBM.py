...
def SDSBM(N: int, K: int, p: float, F: np.array, size_ratio: float=1, eta: float=0.1, seed: int=None) -> Tuple[sp.spmatrix, np.array]:
    """A signed directed stochastic block model graph generator.
    ...
    Arg types:
        ...
        * **seed** (int, optional) - Random seed for reproducible graph generation.
